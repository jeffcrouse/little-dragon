...
var RadialUVGradient = function(params)
{
	params = params || {};
	...
	var matParams = {
		...
		'void main()',
		'{',	
		'	float u = sin((1. - dot(pos,pos)) * PI);',
		// '	u *= sin(vUv.x * 3. * TWO_PI);',
		'	gl_FragColor = vec4( 1., 1., 1., u * weight);//vec4( vec3( u ) * weight, weight);',
...
RadialUVGradient.prototype = Object.create( THREE.ShaderMaterial.prototype );